...
function goran_setup() {
	 ...
	 */
	add_image_size( 'edin-thumbnail-landscape', 350, 254, true );
	add_image_size( 'edin-thumbnail-square', 314, 314, true );
	add_image_size( 'edin-featured-image', 800, 9999 );
	add_image_size( 'edin-hero', 1230, 1230 );
        add_image_size( 'posthome', 340, 230, true);
...
function authors_taxonomy() {
	// create a new taxonomy
	register_taxonomy('integrantes', 'post', array(
    // Hierarchical taxonomy (like categories)
    'hierarchical' => true,
    // This array of options controls the labels displayed in the WordPress Admin UI
    'labels' => array(
      'name' => _x( 'Integrantes', 'taxonomy general name' ),
      'singular_name' => _x( 'Integrante', 'taxonomy singular name' ),
      'search_items' =>  __( 'Buscar integrantes' ),
      'all_items' => __( 'Todos los integrantes' ),
      'parent_item' => __( 'Responsable del integrante' ),
      'parent_item_colon' => __( 'Responsable del integrante:' ),
      'edit_item' => __( 'Editar integrante' ),
      'update_item' => __( 'Actualizar integrante' ),
      'add_new_item' => __( 'Añadir nuevo integrante' ),
      'new_item_name' => __( 'Nuevo nombre de integrante' ),
      'menu_name' => __( 'Integrantes' ),
    ),
...
add_action( 'init', 'authors_taxonomy', 0 );
